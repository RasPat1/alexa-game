...
var handlers = {
    'LaunchRequest': function () {
        ...
        this.emit(':tell', 'Welcome to Catville. A place known far and wide for it’s rolling hills, humble architecture, and endless supply of yarn. The citizens of this quaint little village have lived here in peace for decades. That is… until last night. Sheriff Katz {need better name} was found murdered early this morning, locked in one of his own cells. His throat slit and traces of white foam down his neck. We have a rabies infected murderer on the loose! The town doctor has concurred that the killer is suffering from Rabies Nocturnum, a rare form of the disease that only displays symptoms at night. What the fuck do we do?! The town has congregated at the court house to deliberate on what to do. All players, text your name to 6 3 1 7 5 9 8 3 5 5 to begin the cat hunt.');
